...
class ClientLogin:
    ...
    def _process_response(self, resp):
        """Internal method to process the response and split it into a dict."""
    ...
    def request_tokens(self):
        ...
        Returns nothing, you should probably use get_auth_token instead.
        """
    ...
    def is_authenticated(self):
        ...
        return (self.auth_token is not None) and (self.sid_token is not None)
